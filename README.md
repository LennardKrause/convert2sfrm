...
An easy-to-use GUI to convert BioMAX (EIGER2) or MicroMAX (EIGER2/JUNGFRAU) data to the Bruker ***.sfrm*** format. It makes extensive use of hardcoded defaults to streamline the experience. If you are looking to convert PILATUS3 data, I have [good news](https://github.com/LennardKrause/p3fc) for you too!
